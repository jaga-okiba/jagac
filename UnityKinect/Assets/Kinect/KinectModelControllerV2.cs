...
public class KinectModelControllerV2 : MonoBehaviour {
	...
	private GameObject Fingers_Right; //unused
	private GameObject Hip_Override;
	...
	*/
	...
	public void setBody(GameObject root){
		Component[] target = root.GetComponentsInChildren<Component> ();
		//target = root.GetComponentsInChildren<Component> ();

		for(int i=0;i<target.Length;i++){
			if(target[i].gameObject.name=="SpineRoot"){Hip_Center=target[i].gameObject;}
			else if(target[i].gameObject.name=="Spine2"){Spine=target[i].gameObject;}
			else if(target[i].gameObject.name=="HeadRoot"){Shoulder_Center=target[i].gameObject;}
			else if(target[i].gameObject.name=="Head"){Head=target[i].gameObject;}
			else if(target[i].gameObject.name=="LShoulder"){Collar_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LArmRoot"){Shoulder_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LForearm"){Elbow_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LHand"){Wrist_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LHandEff"){
				Hand_Left=target[i].gameObject;
				Fingers_Left=target[i].gameObject;
			}
			//else if(target[i].gameObject.name=="LHandEff"){Fingers_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="RShoulder"){Collar_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RArmRoot"){Shoulder_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RForearm"){Elbow_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RHand"){Wrist_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RHandEff"){
				Hand_Right=target[i].gameObject;
				Fingers_Right=target[i].gameObject;
			}
			//else if(target[i].gameObject.name=="RHandEff"){Fingers_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="Spine1"){Hip_Override=target[i].gameObject;}
			else if(target[i].gameObject.name=="LLegRoot"){
				Hip_Left=target[i].gameObject;
			}
			else if(target[i].gameObject.name=="LShin"){Knee_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LRootFoot"){Ankle_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="LToe"){Foot_Left=target[i].gameObject;}
			else if(target[i].gameObject.name=="RLegRoot"){
				Hip_Right=target[i].gameObject;
			}
			else if(target[i].gameObject.name=="RShin"){Knee_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RRootFoot"){Ankle_Right=target[i].gameObject;}
			else if(target[i].gameObject.name=="RToe"){Foot_Right=target[i].gameObject;}
		}
